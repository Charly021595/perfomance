    ...
    <div id="sidebar_global" class="sidebar color_fratech">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php if($_SESSION['RHEvaluacion'] == '8999' || $_SESSION['RHEvaluacion'] == '4857' || $_SESSION['RHEvaluacion'] == '8894' || $_SESSION['RHEvaluacion'] == '7818'){ ?>
          <li class="nav-item">
            <a href="RetroalimentacionHistorial.php"class="nav-link active">
              <i class="fa-solid fa-file-contract"></i>
              <p>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            <h1 class="m-0">Hisorial Retroalimentación</h1>
          </div><!-- /.col -->
          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../dashboard.php">Inicio</a></li>
              <li class="breadcrumb-item active">Hisorial Retroalimentación</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
				<div class="card">
					...
					<div class="card-body">
						<div class="row">
							<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
								<label for="lblNombreVisita">Año:</label>
							</div>
							<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
								<select  class="form-control" id="txtAnioSeleccionado" onchange="RevisarEstatusPeriodo();">
								</select>
							</div>
						</div>
					</div>
...
<script src="../assets/plugins/jquery/jquery.min.js"></script>
  ...
  <script src="../assets/js/retroalimentacionHistorial.js?t=<?=time()?>"></script>
</body>
</html>