    ...
    <div id="sidebar_global" class="sidebar color_fratech">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <?php if($_SESSION['RHEvaluacion'] == '8999' || $_SESSION['RHEvaluacion'] == '4857' || $_SESSION['RHEvaluacion'] == '8894' || $_SESSION['RHEvaluacion'] == '7818'){ ?>
          <li class="nav-item">
            <a href="Evaluacion_historial.php"class="nav-link active">
              <i class="fa-solid fa-file-contract"></i>
              <p>
          	...
          	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="form-group row col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12" id="divIDVisita">
							<label for="txtIdMeta" class="col-xs-5 col-sm-5 col-md-5 col-lg-5 col-xl-5 col-xxl-5">Calificación Global Evaluación del Desempeño:</label>
...
<script src="../assets/plugins/jquery/jquery.min.js"></script>
  ...
  <script src="../assets/js/evaluacionhistorial.js?t=<?=time()?>"></script>
</body>
</html>