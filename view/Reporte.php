    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
            <div class="card">
              <div class="card-header color_fratech letra_iconos_blancos">Reporte</div>
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 centrar_texto">
                    <iframe title="Reporte Performance - Metas-Hitos" width="1140" height="541.25" src="https://app.powerbi.com/reportEmbed?reportId=1470d232-75d2-48dc-a50e-f48e4fe517c6&autoAuth=true&ctid=fae0dd8a-65f7-41b3-be31-adec0014b620&config=eyJjbHVzdGVyVXJsIjoiaHR0cHM6Ly93YWJpLXBhYXMtMS1zY3VzLXJlZGlyZWN0LmFuYWx5c2lzLndpbmRvd3MubmV0LyJ9" frameborder="0" allowFullScreen="false"></iframe>
                  </div>
                </div>
              </div>
            </div>
...
<script src="../assets/plugins/jquery/jquery.min.js"></script>
  ...
  <script src="../assets/js/reporte.js?t=<?=time()?>"></script>
</body>
</html>