...
<head>
  ...
  <title>Calificar Metas Anuales</title>
    ...
    <div id="sidebar_global" class="sidebar color_fratech">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <?php } ?>
          <li class="nav-item">
            <a href="CalificarMetas.php"class="nav-link active">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            <h1 class="m-0">Validación de Evaluación del Desempeño</h1>
          </div><!-- /.col -->
          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../dashboard.php">Inicio</a></li>
              <li class="breadcrumb-item active">Validación de Evaluación del Desempeño</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->

        <div id="filtros_validacion" class="row form-group" style="display:none;">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                    <label for="lblNombreVisita" class="col-sm-3 col-form-label">Colaborador:</label>
                  </div>
                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
        ...
        <!-- Levantar Metas -->
        <div class="row" id="validacion_metas_eva" style="display: none;">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
            <div class="card">
              <div class="card-header color_fratech letra_iconos_blancos">Validación de Evaluación del Desempeño</div>
              <div class="card-body">
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
				...
				<div class="form-group row" id="divIDVisita">
				 ...
				 <div class="form-group row" id="divIDVisita">
					...
					<div class="col-sm-8">
						<textarea rows="4" cols="50" maxlength="600" class="form-control" id="txtComentarioRechazoModalEvaluada"> </textarea>
					</div>
				 </div>
				<!-- -->
				<!-- -->
		  ...
		  <div class="modal-footer">
			<button type="button" class="btn btn-success" onclick ="ConfirmacionEvaluacionAceptarMeta()">Aprobar</button>
			<button type="button" class="btn btn-success" onclick ="ConfirmacionEvaluacionRechazarMeta()">Rechazar</button>
...
<script src="../assets/plugins/jquery/jquery.min.js"></script>
  ...
  <script src="../assets/js/CalificarMetas.js?t=<?=time()?>"></script>
</body>
</html>