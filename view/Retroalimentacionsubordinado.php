    ...
    <div id="sidebar_global" class="sidebar color_fratech">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="retroalimentacionsubordinado.php" class="nav-link active">
              <i class="fa-solid fa-comments"></i>
              <p>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            <h1 class="m-0">Retroalimentación Empleados</h1>
          </div><!-- /.col -->
          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../dashboard.php">Inicio</a></li>
              <li class="breadcrumb-item active">Retroalimentación Empleados</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
				<div class="card">
					...
					<div class="card-body">
						<div class="row">
							<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
								<label for="lblNombreVisita">Colaborador:</label>
							</div>
							<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
								<select  class="form-control" id="txtEmpleadoSeleccionado" onchange="RevisarEstatusPeriodo()">
								</select>
							</div>
						</div>
					</div>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
				<ul class="nav nav-tabs" id="myTab" role="tablist">
					<li class="nav-item" role="presentation">
						<button class="nav-link active" id="retroalimentacion_empleado-tab" data-toggle="tab" data-target="#retroalimentacion_empleado" type="button" role="tab" aria-controls="retroalimentacion_empleado" aria-selected="true">Retroalimentación 1</button>
					</li>
					<li class="nav-item" role="presentation">
						<button class="nav-link" id="retroalimentacion_dos_empleado-tab" data-toggle="tab" data-target="#retroalimentacion_dos_empleado" type="button" role="tab" aria-controls="retroalimentacion_dos_empleado" aria-selected="false">Retroalimentación 2</button>
					</li>
					<li class="nav-item" role="presentation">
						<button class="nav-link" id="retroalimentacion_tres_empleado-tab" data-toggle="tab" data-target="#retroalimentacion_tres_empleado" type="button" role="tab" aria-controls="retroalimentacion_tres_empleado" aria-selected="false">Retroalimentación 3</button>
					</li>
				</ul>
			</div>
		</div>
        ...
        <div class="row form-group">
          	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
				...
				<div class="tab-content" id="myTabContent">
					<div class="tab-pane fade show active" id="retroalimentacion_empleado" role="tabpanel" aria-labelledby="retroalimentacion_empleado-tab">
						<div class="card">
					...
					<div class="tab-pane fade" id="retroalimentacion_dos_empleado" role="tabpanel" aria-labelledby="retroalimentacion_dos_empleado-tab">
						<div class="card">
					...
					<div class="tab-pane fade" id="retroalimentacion_tres_empleado" role="tabpanel" aria-labelledby="retroalimentacion_tres_empleado-tab">
						<div class="card">
...
<script src="../assets/plugins/jquery/jquery.min.js"></script>
  ...
  <script src="../assets/js/retroalimentacionsubordinado.js?t=<?=time()?>"></script>
</body>
</html>