...
<head>
  ...
  <title>Validar Metas Anuales</title>
    ...
    <div id="sidebar_global" class="sidebar color_fratech">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php } ?>
          <li class="nav-item">
            <a href="ValidarMetas.php"class="nav-link active">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            <h1 class="m-0">Validar Metas</h1>
          </div><!-- /.col -->
          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../dashboard.php">Inicio</a></li>
              <li class="breadcrumb-item active">Validar Metas</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
        ...
        <div class="row" id="validacion_metas_eva" style="display: none;">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
            <div class="card">
              <div class="card-header color_fratech letra_iconos_blancos">Metas Anuales</div>
              <div class="card-body">
        ...
        <div class="row" id="aviso_alertas" style="display: none;">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
            <div class="card">
              <div class="card-header color_fratech letra_iconos_blancos">Aviso</div>
              <div class="card-body">
                <div class="row form-group">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <div id="avisos_alertas_add" class="alert alert-info"></div>
                  </div>
                </div>
              </div>
            </div>
...
<script src="../assets/plugins/jquery/jquery.min.js"></script>
  ...
  <script src="../assets/js/ValidaMetas.js?t=<?=time()?>"></script>
</body>
</html>